...
$sql = "SELECT UsuarioID, Nome_completo, Email, Usuario, Imagem, CEP, Endereco, Cidade, Estado, Numero, Distancia, Latitude, Longitude, Senha FROM usuarios WHERE Usuario = '{$user}' AND Senha = '{$senha}' ";
