...
$sql = "SELECT UsuarioID, Nome, Sobrenome, Email, Usuario, Imagem, CEP, Endereco, Cidade, Estado, Numero, Complemento FROM usuarios WHERE Usuario = '{$user}' AND Senha = '{$senha}' ";
